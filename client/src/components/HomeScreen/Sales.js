    ...
    <div
      ...
      <div className='container mx-auto h-60 flex items-center justify-start md:justify-center'>
        <div
          ...
          <Link to='/products' className='inline-block bg-gray-700 text-white py-2 px-5 rounded font-medium uppercase  lg:py-3 lg:px-5 lg:text-xl  focus:outline-none focus:ring-2'>
            view Sale
          </Link>
          <div className='mt-4 '>
